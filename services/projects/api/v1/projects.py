...
class ProjectsApi(Resource):
    def get(self) -> dict[str, list]:
        ...
        # "read" access (E.G. been in the queue or is an admin) --> alternative definition: in a room that is registered
        # to the project but is not an admin.
        # TODO: clean this up
        ...
        data = [i.to_mongo() for i in ProjectDocument.objects(
            __raw__={'admins.id': {'$eq': usersId}}
        ).paginate(page=request.args.get('page', 1), per_page=request.args.get('limit', 50)).items]
